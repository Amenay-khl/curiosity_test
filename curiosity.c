...
int main(int argc, char ** argv) {
  ...
  switch(res) {
  case OK_ROBOT: printf("Robot sur une case libre, programme non termine\n"); break;
  case SORTIE_ROBOT: printf("Le robot est sorti de la carte \n"); break;
  case ARRET_ROBOT: printf(" le Robot est sur une case libre a la fin du programme\n"); break;
  case PLOUF_ROBOT: printf("Le robot est tombe dans l'eau \n"); break;
  case CRASH_ROBOT: printf("Le robot s'est ecrase sur un rocher \n"); break;
